    ...
    return (
        ...
        >
            <div className="flex flex-col border-b border-slate-200 px-4 pt-2.5 sm:flex-row sm:items-end sm:justify-between">
                <span className="pb-2 font-mono text-meta font-bold tracking-label text-slate-600 uppercase">
                    Install package
                </span>
                <TabsList
                    variant="line"
                ...
                >
                    {Object.keys(INSTALL_COMMANDS).map((manager) => (
                        <TabsTrigger
                            key={manager}
                            value={manager}
                            className="px-2 font-mono text-meta capitalize"
                        >
                            {manager}
                        </TabsTrigger>
                    ))}
            ...
            <div className="flex flex-wrap justify-between gap-2 border-t border-slate-200 bg-slate-50 px-4 py-2 text-meta text-slate-500">
                <span>
                    <b className="text-foreground">64</b> known codes
                </span>
                <span>
                    <b className="text-foreground">0</b> dependencies
                </span>
                <span>
                    <b className="text-foreground">MIT</b> licensed
                </span>
            </div>
        </Tabs>
    )
